...
ALL of "do them all" now done: fee-splitter decision, agency UI verify, mark-as-played, auto-chase. Remaining tiny/optional: edit-form venue autocomplete; splitter commission-row UI not browser-eyeballed (needs a premium lineup).
