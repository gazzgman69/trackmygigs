...
VERIFY WHEN REPL UP: GET /venues/recent returns his venues; /distance?destination=<a known venue addr> returns cached:true + matching miles (no Google); wizard shows "Your venues" and tapping one reuses mileage. Repl slept again right after push 3fcf4e9.
